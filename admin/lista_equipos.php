...
<div class="container-xl px-4 mt-4">	
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-center text-primary">Equipos registrados</h6>
            ...
            <table class="table table-bordered" id="tablaOjeador" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <?php 
                        $resultado=dameConsulta("SELECT * from usuario  where tipo='team'");
                    ...
                    ?>
                        <tr>
                            ...
                            <th>
                              <a href="perfil_equipo.php?id=<?php echo $mostrar['id'] ?>" class="btn btn-info">Ver</a>
                            <?php 
                            if($activado=='si'){
                                    echo "
