                                            ...
                                            <div class="row mb-3">
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input class="form-control" id="inputPartido" name="inputPartido" type="text"  placeholder="Equipo/jugador" value=""required>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="mb-4">
                                                    ...
                                                    <?php
                                                        ...
                                                        registrar_resena($_SESSION['id'],$_SESSION['id_equipo']);
                                                    ?>
