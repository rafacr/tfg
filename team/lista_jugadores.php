...
<div class="row">
        ...
        <a href="../funciones/plantilla_excel/exportar_listajugadores.php" class="btn btn-success shadow-sm"><i class=" text-white-50"></i> Exportar Excel</a>
        <br></br>
        </div>
</div>
        ...
        <div class="table-responsive">
            <table class="table table-bordered" id="tablaBenjamin" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <?php 
                        $resultado=dameConsulta("SELECT * from jugador where id_equipo='".$_SESSION['id']."' AND categoria='benjamin' AND equipo!='mi equipo'");
                    ...
                    ?>
                        <tr>
                            ...
                            <td id="equipo"><?php  echo $mostrar['equipo']?></td>
  ...
  <div class="tab-pane fade" id="alevin" role="tabpanel" aria-labelledby="alevin-tab">
        ...
        <table class="table table-bordered" id="tablaAlevin" width="100%" cellspacing="0">
                ...
                <tbody>
                    <!-- Bucle con la consulta para mostrar en la tabla -->
                    <?php 
                        $resultado=dameConsulta("SELECT * from jugador where id_equipo='".$_SESSION['id']."' AND categoria='alevin' AND equipo!='mi equipo'");
  ...
  <div class="card-body">
        ...
        <table class="table table-bordered" id="tablaInfantil" width="100%" cellspacing="0">
                ...
                <tbody>
                    <!-- Bucle con la consulta para mostrar en la tabla -->
                    <?php 
                        $resultado=dameConsulta("SELECT * from jugador where id_equipo='".$_SESSION['id']."' AND categoria='infantil' AND equipo!='mi equipo'");
  ...
  <div class="card-body">
        ...
        <table class="table table-bordered" id="tablaCadete" width="100%" cellspacing="0">
                ...
                <tbody>
                    <!-- Bucle con la consulta para mostrar en la tabla -->
                    <?php 
                        $resultado=dameConsulta("SELECT * from jugador where id_equipo='".$_SESSION['id']."' AND categoria='cadete' AND equipo!='mi equipo'");
  ...
  <div class="card-body">
        ...
        <table class="table table-bordered" id="tablaJuvenil" width="100%" cellspacing="0">
                ...
                <tbody>
                    <!-- Bucle con la consulta para mostrar en la tabla -->
                    <?php 
                        $resultado=dameConsulta("SELECT * from jugador where id_equipo='".$_SESSION['id']."' AND categoria='juvenil' AND equipo!='mi equipo'");
  ...
  <div class="card-body">
        ...
        <table class="table table-bordered" id="tablaProfesional" width="100%" cellspacing="0">
                ...
                <tbody>
                    <!-- Bucle con la consulta para mostrar en la tabla -->
                    <?php 
                        $resultado=dameConsulta("SELECT * from jugador where id_equipo='".$_SESSION['id']."' AND categoria='amateur' AND equipo!='mi equipo'");
